...
public class SystemPermissionHelper {
    ...
    private static final int PERMISSIONS_FOR_MIC = 4040;
    private static final int PERMISSIONS_FOR_MICROPHONE = 5050;
    ...
    public boolean isAudioPermissionGranted() {
        return isPermissionGranted(Manifest.permission.MODIFY_AUDIO_SETTINGS);
    }
    ...
    public void requestPermissionsMic() {
        checkAndRequestPermissions(PERMISSIONS_FOR_MIC, Manifest.permission.MODIFY_AUDIO_SETTINGS);
    }


    public void requestPermissionsMicrophone() {
        checkAndRequestPermissions(PERMISSIONS_FOR_MICROPHONE, Manifest.permission.RECORD_AUDIO);
    }
